...
// Item affix with consistent effects
// NOTE: Generated by code (AffixDatabase), not by LLM
...
// A detailed equipment item
// NOTE: Generated by code (ItemAffixGenerator), not by LLM
